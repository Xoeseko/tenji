...
class TxtToSpeech {
  ...
  Future speak(Direction_EN dir) async {
    ...
    if (directionTxt != this.directionPrev || this.directionPrev == null) {
      print(directionPrev);
      this.directionPrev = directionTxt;
      await flutterTts.setVolume(volume);
      await flutterTts.setSpeechRate(rate);
      await flutterTts.setPitch(pitch);

      if (directionTxt != null) {
        if (directionTxt.isNotEmpty) {
          await flutterTts.awaitSpeakCompletion(true);
          await flutterTts.speak(directionTxt);
        }
      }
    }
